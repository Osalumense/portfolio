...
const Modal = ({canShow, updateModalState, props}) => {
    ...
    if (canShow) {
        ...
        <>
          <div
            className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-6 z-50 outline-none focus:outline-none backdrop-blur-md"
          >
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-slate-900 outline-none focus:outline-none">
                ...
                <div className="flex items-center justify-center gap-x-6 p-6 rounded-b">
                    <a target="_blank" rel="noreferrer" className="text-white bg-gradient-to-r from-yellow-400 to-slate-600 via-zinc-500 hover:scale-90 transition ease-in duration-500 px-4 py-2 shadow-xl rounded-2xl" href={props.ghLink}>View on GitHub</a>
                    <a target="_blank" rel="noreferrer" className="text-white bg-gradient-to-r from-yellow-400 to-slate-600 via-zinc-500 hover:scale-90 transition ease-in duration-500 px-4 py-2 shadow-xl rounded-2xl" href={props.liveLink} >View Demo</a>
          ...
          <div className="opacity-25 fixed inset-0 z-40 bg-slate-800 dark:bg-yellow-400"></div>
        </>
        );
    }
  return null;
