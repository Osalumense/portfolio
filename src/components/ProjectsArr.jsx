export const projectsArr = [
        ...
        {
           id: 2,
           img: 'https://user-images.githubusercontent.com/43953425/175952547-ba4ccdb9-e001-4f51-ac81-01290dc02d7d.png',
            overview: 'A website for a Medical Diagnostics Company',
            details: {
               title: 'Labogen Diagnostics',
               description: 'The client needed a website that showcases their services and also some of their products for customer to gather information about them, seek their services and also immediately shop products. I designed the website using WordPress and WooCommerce',
               vid: 'https://streamable.com/glcz4d?autoplay=1&loop=0',
               techStack: ['WordPress', 'WooCommerce'],
               ghLink: '',
               liveLink: 'https://labogendiagnostics.com/',
            }
        },
        {
         id: 3,
      ...
      },
        {
            ...
            overview: 'A react web template designed for small businesses and startups ',
            details: {
